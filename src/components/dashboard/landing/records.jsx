...
function Records() {
  return (
    <div className="flex flex-wrap md:flex-row gap-4 items-center justify-between m-6">
      <div className="w-[500px] bg-gray-400 rounded-2xl p-2 md:p-5">
        <div className="relative">
          <h3 className="text-left font-bold text-sec-blue text-[24px] sm:text-2xl md:text-3xl">
            Past Appointments
          </h3>
          <a
            href=""
        ...
        <div className="text-rose-500 text-[18px] md:text-xl font-bold text-left">
      ...
      <div className="w-[500px] md:h-[420px] bg-gray-400 rounded-2xl p-2 md:p-5">
        <div className="flex relative">
          <div className="flex items-center gap-1 ml-5">
            ...
            <h3 className="text-2xl font-bold text-sec-blue">
              Recent Health <br /> Records
            </h3>
          </div>
          <a
            href=""
            className="capitalize text-left absolute top-4 font-semibold right-0 md:flex hidden text-[14px] items-center"
          >
            view all
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="">
          <div className="flex justify-between border-b p-2">
            <div className="">
              <h2 className="font-bold text-[18px]">Routine Checkup</h2>
              <p className="font-semibold">March 18, 2025, DR, Sarah Johnson</p>
            </div>
          ...
          <div className="flex justify-between border-b p-2">
            <div className="">
              <h2 className="font-bold text-[18px]">Annual Physical</h2>
          ...
          <div className="flex justify-between border-b p-2">
            <div className="">
              <h2 className="font-bold text-[18px]">Blood Work Analysi</h2>
              <p className="font-semibold">March 18, 2025, DR, Orji Johnson</p>
            </div>
            <div className="cursor-pointer flex items-center justify-center gap-1.5">
              <div className="">
                {/* transaction icon */}
