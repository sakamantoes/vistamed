...
function Consultants() {
  return (
    <div className="flex items-center md:justify-between justify-center gap-4  flex-wrap">
      <div className="flex bg-gray-200 rounded-md flex-col gap-3 p-4">
        ...
        <div className="flex items-center justify-between">
          {" "}
          <div className="">
            <div className="border border-gray-400 p-1 flex gap-1.5 items-center justify-even">
              {/* image */}
      ...
      <div className=" p-4 bg-gray-300 w-[400px] rounded-md flex flex-col gap-4">
        <p>Quick Action</p>
        <hr />
